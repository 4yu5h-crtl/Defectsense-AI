...
│                                                                     │
│  ┌──────────────┐    ┌──────────────┐    ┌───────────────────────┐  │
│  │   5 Station   │    │   Feature    │    │    ML Classifier      │  │
│  │   Sensors     │───▶│  Engineering │───▶│  (GradientBoosting)   │  │
│  │              │    │   Pipeline   │    │                       │  │
│  │ Temperature  │    │              │    │  Accuracy: 98.4%      │  │
│  │ Vibration    │    │ 56 Features  │    │  AUC-ROC:  0.998      │  │
│  │ Pressure     │    │ Rolling Avg  │    │  F1-Score: 0.93       │  │
│  │ Cycle Time   │    │ Z-Scores     │    │                       │  │
│  └──────────────┘    │ Lag Features │    └───────────┬───────────┘  │
│         │            │ Cross-Sensor │                │              │
│         │            └──────────────┘                │              │
...
│         ▼                                            ▼              │
│  ┌──────────────┐                         ┌───────────────────────┐ │
│  │   SQLite DB   │                         │   GenAI Analyzer      │ │
│  │              │                         │                       │ │
│  │ Readings     │                         │  Ollama (Local LLM)   │ │
│  │ Predictions  │                         │  Gemini API           │ │
│  │ Reports      │                         │  Rule-based Fallback  │ │
│  └──────┬───────┘                         └───────────┬───────────┘ │
│         │                                            │              │
│         └──────────────┐    ┌─────────────────────────┘              │
│                        ▼    ▼                                       │
